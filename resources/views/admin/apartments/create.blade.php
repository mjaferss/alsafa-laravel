...
@section('title', __('apartments.add_new'))
    ...
    <div class="card">
        <div class="card-header pb-0">
            <div class="d-flex align-items-center">
                <p class="mb-0">{{ __('apartments.add_new') }}</p>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select @error('beneficiary_type') is-invalid @enderror" name="beneficiary_type" id="beneficiary_type">
                                ...
                                <option value="owner" {{ old('beneficiary_type') == 'owner' ? 'selected' : '' }}>{{ __('apartments.beneficiary_types.owner') }}</option>
                                <option value="tenant" {{ old('beneficiary_type') == 'tenant' ? 'selected' : '' }}>{{ __('apartments.beneficiary_types.tenant') }}</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('beneficiary_id') is-invalid @enderror" type="text" name="beneficiary_id" id="beneficiary_id" value="{{ old('beneficiary_id') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('beneficiary_name_ar') is-invalid @enderror" type="text" name="beneficiary_name_ar" id="beneficiary_name_ar" value="{{ old('beneficiary_name_ar') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('beneficiary_name_en') is-invalid @enderror" type="text" name="beneficiary_name_en" id="beneficiary_name_en" value="{{ old('beneficiary_name_en') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('beneficiary_mobile') is-invalid @enderror" type="text" name="beneficiary_mobile" id="beneficiary_mobile" value="{{ old('beneficiary_mobile') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('beneficiary_email') is-invalid @enderror" type="email" name="beneficiary_email" id="beneficiary_email" value="{{ old('beneficiary_email') }}">
